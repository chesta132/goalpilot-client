import type { OneFieldOnly, TError } from "@/utils/types";
...
const useValidate = <T>(
  ...
  const handleChangeForm = useCallback(
    ...
    <Z extends Partial<T>>(value: OneFieldOnly<Z>, configProp?: DynamicConfig<Config<Z>>[keyof Z]) => {
      ...
      return handleChangeAndValidate<T, T & TError>(value as OneFieldOnly<Partial<T>>, error, setValue, setError, config);
    },
